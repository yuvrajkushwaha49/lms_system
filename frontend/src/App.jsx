/**
 * LMS frontend — talks to API Gateway (port 5000) which proxies to backend microservices.
 * Same /api/* paths; one shared MySQL database behind all services.
 * Frontend routes below do not need to change when services scale independently.
 */
