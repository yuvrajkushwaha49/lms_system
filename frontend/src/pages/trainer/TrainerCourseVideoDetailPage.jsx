...
export default function TrainerCourseVideoDetailPage() {
  ...
  useEffect(() => {
    ...
    const loadEngagement = async () => {
      try {
        ...
        setCommentsMap(
          loadedComments && typeof loadedComments === "object"
            ? loadedComments
            : {},
        );
        setProgressMap(
          loadedProgress && typeof loadedProgress === "object"
            ? loadedProgress
            : {},
        );
      } catch {
                ...
                comments
                  ...
                  .map((comment, idx) => (
                    <div
                      ...
                      className={`admin-comment-item p-3 mb-2 ${idx < comments.length - 1 ? "" : "mb-0"}`}
                    >
                      <p className="mb-1 fw-semibold small">
                        {resolveCommentAuthorName(comment)}
                      </p>
                      <p className="mb-1">{comment.text || comment.comment_text}</p>
