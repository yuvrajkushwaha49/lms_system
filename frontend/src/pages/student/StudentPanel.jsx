    ...
    >
      <div className="container-fluid px-0 student-panel-page" style={{ maxWidth: 1200 }}>
        ...
        <div className="lms-card p-0 overflow-hidden">
          ...
          <div className={`p-3 p-md-4 ${owningManhattanOnly ? 'student-om-shell' : ''}`}>
            {isLoading ? (
              ...
              <>
                <section className="student-om-page">
                  ...
                  <div
                    ...
                    style={{
                      background: `linear-gradient(110deg, rgba(10, 10, 16, 0.3), rgba(10, 10, 16, 0.08)), url(${owningManhattanBanner}) center/cover no-repeat`,
                    }}
                  >
                  </div>
