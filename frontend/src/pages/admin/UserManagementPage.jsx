...
export default function UserManagementPage() {
  ...
  return (
    <DashboardSectionPage title="User Management">
        ...
        <div className="lms-card p-4 p-md-5 mb-3 text-white" style={{ background: 'linear-gradient(90deg,#071d3d,#0d2f69 45%,#0a5dea)' }}>
          <div className="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
            <div>
              ...
              <p className="mb-0 text-light">Manage users, roles, and account status.</p>
            </div>
                ...
                {isLoadingUsers ? (
                  ...
                  filteredUsers.map((user) => (
                    <tr key={`${user.id}-${user.email}`}>
                      ...
                      <td><span className="badge text-bg-info">{user.role || 'Admin'}</span></td>
            ...
            <div className="card shadow-lg border-0" style={{ width: '100%', maxWidth: 520, borderRadius: 18 }}>
              <div className="card-body p-4">
                <div className="d-flex justify-content-between align-items-start mb-3">
                  <div>
                    <h2 className="h4 mb-1">Add admin user</h2>
                    <p className="text-muted mb-0 small">New users are created with Admin role only.</p>
                  </div>
